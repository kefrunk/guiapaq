<h1><?php echo Yii::t('guia','Campos de Golf en')?> Vinalop&oacute; Medio <?php echo Yii::t('guia','y')?> Alto:</h1><br> 
<h2>AlendaClub</h2>
<p>Avda. del Mediterr&aacute;neo,52 <br>0
...
03679 Monforte del Cid (Alicante)<br>
