...
<ul id="comarcas">
    			...
    			<li id="activa"><a  href="<?php echo Yii::app()->request->baseUrl; ?>?r=guia/<?php echo "vinalopo"?>">Vinalpo Alto y Medio</a></li>
    			</ul>
<!-- ========================= BEGIN of tabbed-frame div ======================== -->
					...
					<div id="tabFrame" height="700px">
							...
							<IFRAME name="iframe" src="escapadasVinalopo.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
						
							<div class="tabPane" id="tabPane1">
							<IFRAME name="iframe" src="infoVinalopo.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
						
							
							<div class="tabPane" id="tabPane2">
							<IFRAME name="iframe" src="playasVinalopo.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
							
							<div class="tabPane" id="tabPane3">
							<IFRAME name="iframe" src="golfVinalopo.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
