...
<ul id="comarcas">
    			...
    			<li id="activa" ><a  href="<?php echo Yii::app()->request->baseUrl; ?>?r=guia/<?php echo "alicante"?>">Alicante</a></li>
...
<!-- ========================= BEGIN of tabbed-frame div ======================== -->
					...
					<div id="tabFrame" height="700px">
							...
							<span class="tabMenu" id="tabMenu3" onClick="return raisePanel(3)" onMouseOver="mouseOver(3)" onMouseOut="mouseOut(3)">
							   Golf en Alicante</span>
							</div>
						
							<div class="tabPane" id="tabPane0">
							<IFRAME name="iframe" src="escapadasAlicante.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
						
							<div class="tabPane" id="tabPane1">
							<IFRAME name="iframe" src="infoAlicante.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
						
							
							<div class="tabPane" id="tabPane2">
							<IFRAME name="iframe" src="playasAlicante.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
							
							<div class="tabPane" id="tabPane3">
							<IFRAME name="iframe" src="golfAlicante.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
