...
<head>
	...
	<script type="text/javascript" src="<?php echo Yii::app()->baseUrl; ?>/js/tab-panel.js.css"></script>
				...
				<ul id="comarcas">
    			<li id="activa"><a href="<?php echo Yii::app()->request->baseUrl; ?>?r=guia/<?php echo "elche"?>">Elche y comarca</a></li>
...
<!-- ========================= BEGIN of tabbed-frame div ======================== -->
			<div onload="bodyOnLoad()" onResize="raisePanel(currentMenuIndex)">
					<div id="tabFrame" height="700px" >
							...
							<IFRAME name="iframe" src="escapadasElche.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
