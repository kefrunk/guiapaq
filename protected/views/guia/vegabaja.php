...
<ul id="comarcas">
    			<li ><a href="<?php echo Yii::app()->request->baseUrl; ?>?r=guia/<?php echo "elche"?>">Elche y comarca</a></li>
    			<li ><a  href="<?php echo Yii::app()->request->baseUrl; ?>?r=guia/<?php echo "alicante"?>">Alicante</a></li>
	   			<li id="activa"><a  href="<?php echo Yii::app()->request->baseUrl; ?>?r=guia/<?php echo "vegabaja"?>">Vega Baja</a></li>
    			<li><a  href="<?php echo Yii::app()->request->baseUrl; ?>?r=guia/<?php echo "vinalopo"?>">Vinalpo Alto y Medio</a></li>
    			</ul>
<!-- ========================= BEGIN of tabbed-frame div ======================== -->
					...
					<div id="tabFrame" height="700px">
							...
							<span class="tabMenu" id="tabMenu3" onClick="return raisePanel(3)" onMouseOver="mouseOver(3)" onMouseOut="mouseOut(3)">
							   Golf en Vega Baja</span>
							</div>
						
							<div class="tabPane" id="tabPane0">
							<IFRAME name="iframe" src="escapadasVegabaja.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
						
							<div class="tabPane" id="tabPane1">
							<IFRAME name="iframe" src="infoVegabaja.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
						
							
							<div class="tabPane" id="tabPane2">
							<IFRAME name="iframe" src="playasVegabaja.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
							
							<div class="tabPane" id="tabPane3">
							<IFRAME name="iframe" src="golfVegabaja.php" width=675 height="100%" marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="auto"></IFRAME>
							</div>
