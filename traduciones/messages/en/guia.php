...
return array(
	...
	'Playas' => 'Beaches',
		//Alicante
	'intro playas Alicante' => 'Alicante city is touched by the Mediterranean waters and beautiful beaches are found along the coast. From iconic beaches such as the beach of San Juan or Postiguet passing through the Almadrava, The Albufereta, Muchavista or Urbanova. Not forgetting the beautiful island of Tabarca which can be accessed by ship from the port of the city ' ,
		//Elche y Santa Pola
	'intro arenales' => 'The beach of Arenales del Sol has a golden sand in a wonderful environment, with a particular dune system',
	'intro arenales 2' => 'Its surface is 2800 meters long by 40 meters wide. The average occupation rate is high. Urban and protected beach. The usual state if the sea is moderated waves. Beach suitable for disabled people, with parking, toilettes, showers, téléphone, umbrella, rocky chairs and umbrellas fro renting, water sports',
	'intro Gran Playa' => 'Provided with a Windsurf zone and a rollerskate lane along the promenade, several chiringuitos, restaurants, handicaped access and an acces platform to the boats. Its thin sand and the longitud is special for playing beach sports and also for windsurf and nautic sports.',
	'intro Playa Levante' => '<p>Placed right in the certer of the town and with a big choice of services and infrastructures, it has also a big space for playing games and to make the stay as pleasant as possible. This beach provides acces to handicapped people and has received again in 2013 the Blue Flag badge.',
	'intro Varadero' => 'With all features and services of urban beaches. It has received the Blue Flag badge in 2013 like year after year',
	'intro Calas Santa Pola' =>'It&#39;s a zone full of creeks where sand and rock beaches are mixed. The water are pure clean and with a particular blue color. Some of this creeks have been declared of National Touristic Interest',
	'intro Tamarit' => 'With all features and services of urban beaches. It has received the Blue Flag badge in 2013 like year after year',
	'intro La Marina' => '<p>In La Marina you can enjoy a golden sand beach, open and virgin, that offers blue and clean waters. It is surrounded by a dune barrier making the personality of this beach 100% natural.',
	...
	'intro playas Elche 2' => 'We have to mention as example some beaches like Carabassí beach where we can see The city of Alicante as background thanks to the position of this beach just in the middle of Alicante bay. Not less spectacular are the beaches of Santa Pola with its complete installations. The creeks remember those of Tabarca that can be reached in only 25 minutes from the port of Santa Pola. Going south we find the beaches of La Marina with its characteristics dunes and El Pinet, with natural spirit.',
		//Vega Baja
	'intro playas Vega Baja' => 'Going south along the coast from the mouth of Rio Segura until the province of Murcia we find many beaches, some of them authentic mediterranean paradises. Torrevieja is the main coastal city with the beaches Los Locos, Los Náufragos, El Cura y La Mata beach. Orihuela costa has La Zenia and Playa Flamenca and close to The Mar Menor region are placed the beautiful beaches of Pilar de la Horadada.',
	...
	'intro playas pilarhoradada' => 'The coast of Pilar de la Horadada is over four kilometers long, where we can find two long white sand beaches in strong contrast to the blue sea. Also small rocky cliffs are present, giving as a result a golden sand.',
		//Benidorm
	'intro playa levante benidorm' => 'From Punta Pinet to Punta Canfali appears a wide bay of more than two miles long containing an urban beach that is with no doubt one of the liveliest and busiest on the Mediterranean coast. Thanks to its orientation, you can lie in the sun until late evening in summer and until sunset in winter. It has thin golden sand, clean waters and is decorated with palm trees that give a more attractive look. It is bounded by a promenade with lots of restaurants, cafes and pubs. This beach is also adapted for disabled guests.',
	'intro playas Benidorm'=>'Benidorm beaches are one of the main attractions of the mediterrranean coast',
	'intro playa poniente benidorm' => 'From the port to Cabezo Tossal is extended this beach with more than 3 kilometers long, clean waters and thin and golden sand where a chain of palm trees make it even prettier. Walking on the promenade is a pleasure. This beach provides all necessary services for handicapped people',
	'intro cala mal pas benidorm' => 'Between Punta Canfali and the port we find the small creek with golden sand that has a more calmed atmosphere compared with the crowded beaches of Levante and Poniente. Just in front of the creek you can enjoy the view of Benidorm island, an important marine reserve with an excellent seabed that is a treasure for divers',
	...
	'imgAltAccesomovreducida' => 'Access handicapped',
	...
	'castillos parrafo 1' => 'The "Route of the Castles of the High Vinalopó" allow us to discover some of the villages that
						were created and grew up around a fortress, and which acquired great importance during the Middle Ages. They were
						borderlands and from these castles was controlled important strategically roads, such as
						the one linking the Alicante coast with the inland iberian peninsula (where it now runs
...
is very ancient, for obtaining wine and also for harvesting <strong> table grapes </ strong>. ',
	...
	'Comarca de Alicante' => 'Alicante region',
	...
	'intro Crevillente'=> 'Crevillente is a town at the foot of a mountain that keeps the urban complex structure of its Islamic origins.
						The festival of Moors and Christians have been declared of National Touristic Interest,
						Crevillente is also known for its traditional carpet industry, which giving the nickname "Carpet City" to Crevillente.',
...
reaching Denia crossing paradises like Moraira, the capes of San Antonio and La Nao and the city of Javea',
	...
	'intro hogueras' => 'The main festivity that takes place in the city of Alicante is "Fogueres de Sant Joan"',
	'Hogueras Alicante parrafo 1' => 'This celebration has its origins when farmers used to celebrate the longest day of the year for the fruit harvesting and the shortest night to destroy evil spirits. Today Fogueres de Sant Joan are the official festivities of Alicante and have been declared of International touristic Interest.' ,
	'Hogueras Alicante parrafo 2' => 'From June 17th to 20th are planted the "Fogueres", artistic monuments built of wood, cardboard, cork and paint containing a deep satirical load. Burned four days later after monumental fireworks from Benacantil, the spéctacle is visible from almost any point of the city.',
	...
	'intro misteri elche' =>'Known as LA FESTA, in capital letters, it has been declared World Heritage of Humanity by UNESCO. This is the performance of a sacred lyrical drama the theme of which is the Dormition, Coronation and Assumption of the Holy Virgin into Heaven, performed by singers from Elche on 14th and 15th August. From 11th to 13th August the general rehearsals take place. In spite of the fact that performances were forbidden inside the temples El Misteri survived thanks to a bull [Pope&#39;s edict] that was conceded in the 17th century. Throughout the days that the fiesta lasts also to be highlighted is La Nit de l&#39;Albà, during which the townsfolk offer fireworks to the Holy Virgin and to La Roà from their flat rooftops, covering the area of the old mediaeval walls, holding a wake for the Dormition of the Our Lady. Each year that ends in an even number there are also extraordinary performances on 29th and 30th October and on 1st November. 
						It is a masterpiece of Oral and Intangible Heritage of Humanity.',
	//Vega baja
	'intro semana santa orihuela' => 'The Easter Week in Orihuela is one of the top religio-cultural expressions of Spain, declared of International Touristic Interest, is another cultural attraction of the city together with the visit to the old town which was declared an Historic-Artistic monument in 1969. There are processions on Good Friday (or Friday of Dolores), and each day of the Week from Palm Sunday to Easter Sunday, being the procession of Friday the largest with the participation of ten fraternities and over 8,000 Nazarenes, 1200 musicians, two hundred Roman Praetorian Guard and more than a hundred people. ',
	'intro feria mayo torrevieja'=>'What originnally was a Sevillanas private party between some frieds, after some years has become one of the most important celebrations of the city, The may fair have been celebrated since 1987 giving color and warmth to the city of Torrevieja at the end of 80&#39;s decade. It was declared of touristic interest for Valencia region. The event, runs from Wednesday to Sunday. This act includes at the same time dancing, horse riding, horse shows and daily shows that make it a memorable experience',
	...
	'intro turismo rural'=> 'The rural tourism in the province of Alicante is rich and extensive, we highlght an interesting association close to our entity.
							It is the Association for Rural Development of Elche field ',
	'intro casa catral'=>'In Catral we can find an inviting and hospitable Rural House to relax and enjoy nature with family ',
	'intro campings'=>'Marjal Costa Blanca Eco Camping Resort is inside the municipality of Crevillente. Marjal Costa Blanca is one of the most modern Campsites Resorts in Europe . With high quality installations, a privileged climate and a staff who will make your holiday unforgettable. Ideal to enjoy at any time of the year',
	'intro casa pinoso'=>'Nestled in the beauty of Spain&#39;s diverse countryside, amidst vineyards, cherry orchards and olive groves, Casa 10-11 Guest House Hotel offers a unique getaway. Here during your stay you can have fun, chill out or do something different. ',
	'intro casa petrer'=>'In petrer we can find two rural guest houses, an ideal place for enjoying an amzing natural landscape, ethnological and cultural.',
	...
	'intro gastronomia provincia' => 'The gastronomy of Alicante region has two main gastronomical zones: coast and inland. In coastal places the most typical dishes have fish and seafood, while inland we find dishes with more presence of meat and garden products. Generally, we can say that rice is very common, with a huge variety of paellas, we find a lot of seafood, garden products, and also bakery products and sweets.',
	'Gastronomia de la Provincia de Alicante'=> 'Gastronomy of Alicante region',	
