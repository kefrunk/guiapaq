...
return array(
	...
	'castillo Sax' =>' Le Château de Sax, situé
					...
					(déclarée monument national en 1931) garde à l&#39;intérieur de sa tour principale un intéressant
					voûte fait par les Almohades au XIIe siècle. Au centre historique
					de Biar il ne faut pas oublier de visiter la belle église et autour
					la population, le Sanctuaire de Notre-Dame de Grâce et l&#39;aqueduc médiéval.',
	'castillo Banyeres' =>' Dans le château arabe de Banyeres, situé à 830 mètres au-dessus de la mer dans le centre de la
						population on trouve la grande tour de l&#39;Hommage (ou «Tour Major»), qui est d&#39;une grande
						importance pour les Maures et chrétiens, en honneur du patron Sant Jordi,
...
<strong> produire des vins </ strong>, comme.<a href="http://es.wikipedia.org/wiki/Vino_moscatel" title="Vino moscatel">Moscatel</a>, Fondill&oacute;n (<a href="http://es.wikipedia.org/wiki/Mon%C3%B3var" title="Mon&oacute;var">Mon&oacute;var</a>,&nbsp;<a href="http://es.wikipedia.org/wiki/Pinoso" title="Pinoso">Pinoso</a>, etc,); ou celles engagés dans la production de raisin de table (<a href="http://es.wikipedia.org/wiki/Novelda" title="Novelda">Novelda</a>,&nbsp;<a href="http://es.wikipedia.org/wiki/Aspe" title="Aspe">Aspe</a>,&nbsp;<a href="http://es.wikipedia.org/wiki/Monforte_del_Cid" title="Monforte del Cid">Monforte del Cid</a>, etc,). La grande qualité du raisin récolte dans la région a conduit à la dénomination d&#39;origin&nbsp;<a href="http://es.wikipedia.org/wiki/Uva_de_mesa_embolsada_Vinalop%C3%B3" title="Uva de mesa embolsada Vinalop&oacute;">Raisin de table Vinalop&oacute;</a></p> <p> Autour de cettes villages on peut observer un très beau landscape entouré de vignes, montagnes et aussi d&#39;une spectaculaire marbrière</p> ',
	...
	'Museo del calzado' =>'Musée de la chaussure',
	//Benidorm
	'Recorrido por Benidorm y alrededores' => 'Benidorm et environs',
	...
	//Javea, calpe, denia
	'Recorriendo de Calpe hasta Denia'=>'De Calpe à Denia',
...
Se promener dans ses rues révèle clairement l&#39;effort de son peuple à prospérer dans un environnement d&#39;une grande beauté naturelle, mais extraordinairement compliqué pour le développement urbain ',
	...
	'Cosas que visitar' => 'Lieus à visiter', 
	//---------------------------------------------//
	...
	'Fiestas' => 'Fêtes',
	//Alicante
	'Fiestas en Alicante' =>'Fêtes à Alicante',
	'intro hogueras' => 'La fête la plus importante qui se déroule dans la ville d&#39;Alicante sont les Fogueres de Sant Joan',
	...
	'Hogueras Alicante parrafo 2' => 'Du 17 au 20 Juin sont plantés "Fogueres" monuments artistiques construits en bois,  carton, liège et peinture, contenant une charge satirique profonde. Brûlé quatre jours plus tard après monumentales lancements de feux d&#39;artifice dépuis le mont Benacantil. Le spéctacle est visible depuis presque n&#39;importe quel point de la ville. ',
	'intro semana santa' => 'La Semaine Sainte à Alicante est une célébration de grande importance.',
	'Carnavales' => 'Carnavales',
	'intro Carnavales' => 'Entre les 10 meilleurs carnavals en Espagne, ouvert à tout le monde',
	'santa faz parrafo 1'=>'La procession de masse de la Sainte Faz a lieu la deuxième semaine suivant au Jeudi Saint, en une seule journée. Très tôt, on prend les tiges de romarin et avant d&#39;atteindre le monastère, le déjeuner est marqué comme une arret obligatoire.',
	...
	'intro arroz y mondongo' => 'Dans la plupart des maisons à Crevilente dimanche est le jour du riz. Et même si elle n&#39; est pas consommée chaque dimanche, 
le riz le plus typique de Crevillente est l&#39;arròs amb pota i mondongo(riz avec des tripes de boeuf et de la jambe). Je sais que ça sonne un peu dégoutant, mais il est trop bon.Le Mondongo est tout simplement l&#39;intestin du veau. Et la pota est la jambe du veau.',
	'arroz y mondongo ingredientes'=>'<ul>
				<li>1 Lapin</li>
				<li>1/2 kg de jambe et intestin (entre les deux) </li>
				<li>1 goussed&#39;ail</li>
				<li>1 poivre rouge</li>
				<li>4 tomates mûr<li>
				<li>2 dozenes d&#39;escargots</li>
				<li>200 gr. de pois chiches</li>
				<li>600 gr. de riz</li>
				<li>2,5 litres de bouillon</li>
	...
	'Info Interes' => 'Information d&#39;Intérêt',
	'Fiestas' => 'Fêtes',
	'Hoteles' => 'Hotels',
	'Restaurantes' => 'Restaurants',
	'Telefonos' => 'Telephones d&#39;Intérêt',
	'Policia' => 'Police',
	...
	'elchetitulo' => 'Elche et environs',
	'vinalopotitulo' => 'Vinalopo Moyen et Haute',
	'y' => 'et',
	'Aqui' => 'Ici',
	'Caracteristicas' =>'Charactéristiques',
